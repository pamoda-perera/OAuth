...
<form method="post"><center><input type="submit" name="insert" class="button" value=""/></center></form>
	...
	<h1 class="warning"><b><?php echo $name." is your lover!"; ?></b></h1>
    <section><div class="loader"></div><div class="loader2"></div><div class="images" style="position:relative;left:0;"><?php echo "<img src='".$picture['url']."' class='you' id='you' /><img src='blackboard.jpg'  width='550' height='350' class='blackboard' id='blackboard'/> <p class='content' id='content' style='color:white;'><b>You nick name: $selected_gender<br> place you meet: $selected_country <br> what you get first : $selected_reason</b></p>"; ?></div></section>
